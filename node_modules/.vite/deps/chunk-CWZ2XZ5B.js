...
var _excluded3 = ["className", "color", "component", "components", "disabled", "page", "selected", "shape", "size", "slots", "type", "variant"];
...
var PaginationItem = React7.forwardRef(function PaginationItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaginationItem"
  });
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime8.jsx)(PaginationItemEllipsis, {
    ...
    className: clsx_m_default(classes.root, className),
    children: "\u2026"
  }) : (0, import_jsx_runtime9.jsxs)(PaginationItemPage, _extends({
    ref,
    ownerState,
    component,
    disabled,
    ...
    children: [type === "page" && page, Icon ? (0, import_jsx_runtime8.jsx)(PaginationItemPageIcon, {
      as: Icon,
      ownerState,
...
true ? PaginationItem.propTypes = {
  ...
  components: import_prop_types2.default.shape({
    first: import_prop_types2.default.elementType,
    last: import_prop_types2.default.elementType,
    next: import_prop_types2.default.elementType,
    previous: import_prop_types2.default.elementType
  }),
  disabled: import_prop_types2.default.bool,
  page: import_prop_types2.default.node,
  ...
  type: import_prop_types2.default.oneOf(["end-ellipsis", "first", "last", "next", "page", "previous", "start-ellipsis"]),
...
var _excluded4 = ["boundaryCount", "className", "color", "count", "defaultPage", "disabled", "getItemAriaLabel", "hideNextButton", "hidePrevButton", "onChange", "page", "renderItem", "shape", "showFirstButton", "showLastButton", "siblingCount", "size", "variant"];
...
var Pagination = React8.forwardRef(function Pagination2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPagination"
  });
  const {
    ...
    hideNextButton = false,
    hidePrevButton = false,
    renderItem = (item) => (0, import_jsx_runtime10.jsx)(PaginationItem_default, _extends({}, item)),
    shape = "circular",
    showFirstButton = false,
    showLastButton = false,
    siblingCount = 1,
  ...
  return (0, import_jsx_runtime10.jsx)(PaginationRoot, _extends({
    "aria-label": "pagination navigation",
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other, {
    children: (0, import_jsx_runtime10.jsx)(PaginationUl, {
      className: classes.ul,
      ownerState,
      children: items.map((item, index) => (0, import_jsx_runtime10.jsx)("li", {
...
true ? Pagination.propTypes = {
  ...
  color: import_prop_types3.default.oneOfType([import_prop_types3.default.oneOf(["primary", "secondary", "standard"]), import_prop_types3.default.string]),
  ...
  shape: import_prop_types3.default.oneOf(["circular", "rounded"]),
  ...
  variant: import_prop_types3.default.oneOfType([import_prop_types3.default.oneOf(["outlined", "text"]), import_prop_types3.default.string])
} : void 0;
...
//# sourceMappingURL=chunk-CWZ2XZ5B.js.map
