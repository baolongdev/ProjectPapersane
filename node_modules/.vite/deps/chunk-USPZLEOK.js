...
function createContainer(options = {}) {
  ...
  const Container2 = React83.forwardRef(function Container3(inProps, ref) {
    ...
    return (0, import_jsx_runtime51.jsx)(ContainerRoot, _extends({
      as: component,
      ownerState,
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React93.useState(false);
...
var TouchRipple = React94.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React94.useState([]);
  const nextKey = React94.useRef(0);
  const rippleCallback = React94.useRef(null);
  React94.useEffect(() => {
  ...
  const ignoringMouseDown = React94.useRef(false);
  const startTimer = React94.useRef(0);
  const startTimerCommit = React94.useRef(null);
  const container = React94.useRef(null);
  React94.useEffect(() => {
    return () => {
  ...
  const startCommit = React94.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start2 = React94.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React94.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React94.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
...
var ButtonBase = React95.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const buttonRef = React95.useRef(null);
  ...
  React95.useImperativeHandle(action, () => ({
    focusVisible: () => {
      setFocusVisible(true);
      buttonRef.current.focus();
    }
  ...
  const keydownRef = React95.useRef(false);
  ...
  return (0, import_jsx_runtime57.jsxs)(ButtonBaseRoot, _extends({
    ...
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime56.jsx)(TouchRipple_default, _extends({
      ref: handleRippleRef,
      center: centerRipple
...
var SvgIcon = React96.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime59.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime58.jsx)("title", {
...
var PaginationItem = React102.forwardRef(function PaginationItem2(inProps, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime65.jsx)(PaginationItemEllipsis, {
    ...
    children: [type === "page" && page, Icon ? (0, import_jsx_runtime65.jsx)(PaginationItemPageIcon, {
      as: Icon,
      ownerState,
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-USPZLEOK.js.map
